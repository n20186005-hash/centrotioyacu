    ...
    <section className="hero">
      ...
      <a href={MAPS_URL} target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none", color: "inherit" }}>
        <div className="hero-meta">
          ...
          <div className="hero-reviews">5,071 {t.rating.reviews} · {t.rating.source}</div>
        </div>
      </a>
    </section>
  );
      ...
      <ScrollReveal>
        <div className="location-section">
          <div className="location-map-container">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15000!2d-77.225492!3d-6.045719!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x91b9b9b9b9b9b%3A0x0!2sCentro%20tur%C3%ADstico%20Tio%20Yacu!5e0!3m2!1sen!2sus!4v1700000000000!5m2!1sen!2sus"
              width="800"
              height="600"
              style={{ border: 0 }}
              allowFullScreen
              ...
              title="Centro turístico Tio Yacu Location Map"
            />
          </div>
